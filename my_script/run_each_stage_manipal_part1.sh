...
base_dir_path="/scratch/qingqu_root/qingqu1/wdli/domain_adaptation/CACTIF/data/manipal_update2_sequential/Part_1"


## WARNING: BEFORE YOU START RUNNING THE SCRIPT:
# 1. run AE.sh
