base_dir_path="/scratch/qingqu_root/qingqu1/wdli/domain_adaptation/CACTIF/data/semantic_transformed_2/train"
# base_dir_path="/scratch/qingqu_root/qingqu1/wdli/domain_adaptation/CACTIF/data/semantic_transformed_2/valid"

mkdir $base_dir_path/resized_images_AE2_new_removal
mv $base_dir_path/resized_images_after_AE2_new_removal/* $base_dir_path/resized_images_AE2_new_removal/
# rm -rf $base_dir_path/resized_images_after_AE2_new_removal
...
python data_processing/update_masks_from_json_stage4.py \
    ...
    --output_dir $base_dir_path/masks_selected \
    --search_radius 3

# stage 5: binarize masks
python data_processing/binarize_mask_image_stage5.py   \
    --input_dir $base_dir_path/masks   \
    --output_dir $base_dir_path/masks_binarized
...
python data_processing/paste_person_to_image_stage6.py \
  ...
  --mask_dir $base_dir_path/masks_selected \
  --output_dir $base_dir_path/pasted_image \
...
python data_processing/viz_yolo_boxes_stage8.py \
    --images_dir $base_dir_path/pasted_image   \
    --labels_dir $base_dir_path/labels_kept    \
    --output_dir $base_dir_path/images_for_checking
