...
class RunConfig:
    ...
    # Output path
    output_path: Path = Path('/scratch/qingqu_root/qingqu1/wdli/domain_adaptation/CACTIF/data/synplay_test/synplay_test_nofreeu_step1')
