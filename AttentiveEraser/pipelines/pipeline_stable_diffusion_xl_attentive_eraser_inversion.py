...
class StableDiffusionXL_AE_Pipeline(
    ...
    def __call__(
        ...
        record_list: Optional[List] = None, # AE parameter DIP
        x0_latents: Optional[torch.FloatTensor] = None, # AE parameter DIP
        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                latents = (1 - mask) * self._record_list[i] + mask * latents
                ...
                if num_channels_unet == 4:
                    ...
                    latents = (1 - init_mask) * self._record_list[i] + init_mask * latents """
            ...
            latents = latents * mask + (1-mask) * self._x0_latents
