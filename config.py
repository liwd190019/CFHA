...
class RunConfig:
    ...
    content_image_path: Path=Path("/scratch/qingqu_root/qingqu1/wdli/domain_adaptation/synplay_datasets_process/synplay_test_reformat")
    # Output path
    output_path: Path = Path('./output_synplay_test')
